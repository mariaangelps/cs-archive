...
def litCricFriend(wordList, text):
    ...
    # list of words (after they have belower-cased, and the
    # m-dashes removed). One line of code.

    listof_words=lowercase_text.split()
    ...
    new_word_list=[]
    for i in listof_words:
        new_word_list.append(i.strip(string.punctuation))
    ...
    counter=0
    for i in wordList:
        counter+=new_word_list.count(i.lower())
    ...
    ratio=0
    text_length= len(new_word_list)
    ratio= counter/text_length
    return ratio 
...
print('The_bells_AAn_Frequency',litCricFriend(['a','an'],theBells))
print('CantoXII_AAn_Frequency',litCricFriend(['a','an'],cantoXII))
print('The_bells_the_Frequency',litCricFriend(['the'],theBells))
print('CantoXII_the_Frequency',litCricFriend(['the'],cantoXII))
...
'''
Yes, definitely, because the change in the numbers of the ratio vary when "a,and" and "the"
is used. For thebells when "a,and" and "the" is used, the ratio is greater than in canto. 
'''
